...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void loadItems() {
        String playlistTracksQuery = "SELECT COUNT(stockid) AS cnt, stockname, price FROM stockdata GROUP BY stockid, stockname, price;";
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/stocks", "root", "Dhruv@99269!")) {
            try (java.sql.PreparedStatement statement = connection.prepareStatement(playlistTracksQuery)) {                
                ...
                int itemCount = 0;
                while (resultSet.next() && itemCount < 49) { 
                    String itemName = resultSet.getString("stockname");
...
case 49:
    ...
    public void loadOrders() {
        String playlistQuery1 = "SELECT count(portfolioid), portfolioname, portfolioid FROM portfolio WHERE userid = ? GROUP BY portfolioname,portfolioid;";
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/stocks", "root", "Dhruv@99269!")) {
            try (java.sql.PreparedStatement statement = connection.prepareStatement(playlistQuery1)) {
                statement.setInt(1, userid);                
                java.sql.ResultSet resultSet = statement.executeQuery();
                int orderCount = 0;
                while (resultSet.next() && orderCount < 4) { 
                    String orderName = resultSet.getString(2); 
                    int id=resultSet.getInt(3);
                    switch (orderCount) {
                        case 0:
                            order1.setText(orderName);
                            PortfolioData.setOrderId1(id);                            
                            break;
                        case 1:
                            order2.setText(orderName);
                            PortfolioData.setOrderId2(id);                            
                            break;
                        case 2:
                            order3.setText(orderName);
                            PortfolioData.setOrderId3(id);                            
                            break;
                        case 3:
                            order4.setText(orderName);
                            PortfolioData.setOrderId4(id);                            
                            break;                        
                    }
                    orderCount++;
                }
    ...
    private void initComponents() {
        ...
        addOrder.setBackground(new java.awt.Color(20, 20, 20));
        addOrder.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        addOrder.setForeground(new java.awt.Color(0, 153, 102));
        addOrder.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        addOrder.setText("Create New Portfolio");
        addOrder.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                addOrderMouseReleased(evt);
            }
        });
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(addOrder, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(order1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addComponent(order2, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void addOrderMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addOrderMouseReleased
        // TODO add your handling code here:
        String portfolioName = JOptionPane.showInputDialog(null, "Enter portfolio name:", "Add Order", JOptionPane.PLAIN_MESSAGE);

        if (portfolioName != null && !portfolioName.isEmpty()) { // Check if the user entered a name
            try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/stocks", "root", "Dhruv@99269!")) {
                String insertQuery = "INSERT INTO portfolio(portfolioname, userid) VALUES (?, ?)";
                ...
                try (java.sql.PreparedStatement statement = connection.prepareStatement(insertQuery)) {
                    ...
                    if (rowsAffected > 0) {
                        JOptionPane.showMessageDialog(null, "Portfolio added successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
                        loadOrders();
                    } else {
                        JOptionPane.showMessageDialog(null, "Failed to add portfolio.", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (SQLException ex) {
            ...
            JOptionPane.showMessageDialog(null, "Portfolio name cannot be empty.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_addOrderMouseReleased

    private void order2MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_order2MouseReleased
        // TODO add your handling code here:
        dispose();
        Portfolio2 ads=new Portfolio2();
        ads.setVisible(true);
    }//GEN-LAST:event_order2MouseReleased

    private void order3MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_order3MouseReleased
        // TODO add your handling code here:
        dispose();
        Portfolio3 ads=new Portfolio3();
        ads.setVisible(true);
    }//GEN-LAST:event_order3MouseReleased

    private void order1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_order1MouseReleased
        // TODO add your handling code here:
        dispose();
        Portfolio1 ads=new Portfolio1();
        ads.setVisible(true);
    }//GEN-LAST:event_order1MouseReleased

    private void order4MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_order4MouseReleased
        // TODO add your handling code here:
        dispose();
        Portfolio4 ads=new Portfolio4();
        ads.setVisible(true);
    }//GEN-LAST:event_order4MouseReleased
